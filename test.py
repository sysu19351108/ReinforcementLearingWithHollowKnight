...
def test_run(hp, algorithm, agent, act_rmp_correct, move_rmp_correct, PASS_COUNT, paused):
    restart()
...
if __name__ == '__main__':
    ...
    while episode < max_episode:  # 训练max_episode个回合，test部分不计算入episode数量
        ...
        total_reward, total_step, PASS_COUNT, remind_hp = test_run(hp, algorithm, agent, act_rmp_correct,
        ...
        print("Episode: ", episode, ", pass_count: ", PASS_COUNT, ", reward:", total_reward)
